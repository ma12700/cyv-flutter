...
class AnimatedFab extends StatefulWidget {
  ...
  const AnimatedFab({Key key, this.onClick, this.onClick2}) : super(key: key);
...
class _AnimatedFabState extends State<AnimatedFab>
        ...
        builder: (BuildContext context, Widget child) {
          return new Stack(
            ...
            children: <Widget>[
              ...
              _buildOption(Icons.camera_alt, 0.0, widget.onClick),
              _buildOption(Icons.insert_comment, -math.pi / 3, widget.onClick2),
  ...
  Widget _buildOption(IconData icon, double angle, Function testDa) {
